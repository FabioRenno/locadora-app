...
O objetivo é garantir que as sugestões, alterações e implementações
respeitem o estágio do projeto, o contexto do fundador e a simplicidade
necessária para um MVP em produção.
...
Se algo já funciona e está claro, a tendência deve ser **preservar e
melhorar aos poucos**.
...
## 5. Regra adicional sobre refatorações amplas

A IA não deve propor ou executar refatorações grandes automaticamente.

Antes de sugerir uma refatoração que afete muitos arquivos ou mude a
estrutura do projeto, a IA deve primeiro explicar:

-   qual problema concreto está sendo resolvido
-   qual risco existe na mudança
-   qual benefício prático imediato ela traz
-   quantos arquivos serão afetados

Se a mudança for significativa, a IA deve **perguntar primeiro** antes
de continuar.

------------------------------------------------------------------------

## 6. Preservar o fluxo principal do produto
...
## 7. Código deve ser fácil de entender
...
## 8. Explicar como um parceiro técnico, não como professor rebuscado
...
A IA não deve tratar este projeto como se já fosse uma plataforma madura
de larga escala.

------------------------------------------------------------------------

## 10. Ao sugerir melhorias
...
## 11. Ao escrever ou revisar documentação
...
## 12. Ao mexer em banco de dados

Como o projeto usa PostgreSQL (Neon), qualquer alteração de estrutura
...
## 13. Ao mexer em rotas, autenticação e permissões
...
## 15. Regra de estilo para respostas e implementações
...
## 16. Em caso de dúvida

Em vez de inventar complexidade, a IA deve seguir a opção mais segura
entre estas:
...
Se uma solução parecer tecnicamente elegante, mas dificultar
entendimento, manutenção ou evolução prática, ela não é a melhor solução
